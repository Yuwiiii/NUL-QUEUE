...
if (isset($_SESSION['full_name']) && isset($_SESSION['office'])) {
    ...
    if (isset($_GET['program'])) {
        ...
        $sql = "SELECT * FROM academics_queue WHERE program = '$selectedProgram' AND availability = 0";
        ...
        if ($result->num_rows > 0) {
            ...
            $sql = "SELECT * FROM academics_queue WHERE program = '$office' AND concern = '$full_name' AND availability = 0 ORDER BY timestamp ASC";
            $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
                ...
                echo '<b><i>No queuing number available for this person.</i></b>';
            }
        }
    } else {
