...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlUpdateAccounting = "UPDATE registrar SET window = '$userWindow' WHERE queue_number = '$selectedQueueNumber'";
    ...
    if ($conn->query($sqlUpdateAccounting) === TRUE) {
        ...
        VALUES ('$selectedQueueNumber', '$userWindow', 'Registrar')
        ON DUPLICATE KEY UPDATE window = '$userWindow'";

        // Execute the query to update the display table
